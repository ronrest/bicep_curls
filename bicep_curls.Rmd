...
#' cacheDownload.csv 
#' 
#' Downloads a csv file from the internet, and caches it locally. 
#' 
#' Something
#' 
...
#' 
cacheDownload.csv <- function(url, dataDirectory, fileNameLocal){
...
cacheDownload.csv(trainURL, "data", "trainData")
cacheDownload.csv(testURL, "data", "testData")
```
